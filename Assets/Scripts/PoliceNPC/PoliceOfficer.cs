...
public class PoliceOfficer : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (!playerInvisionRadius && !playerInshootingRadious && wantedLevelScript.level1 == false || wantedLevelScript.level2 == false || wantedLevelScript.level3 == false || wantedLevelScript.level4 == false || wantedLevelScript.level5 == false)
        {
            Walk();
        }
        if (playerInvisionRadius && !playerInshootingRadious && wantedLevelScript.level1 == true || wantedLevelScript.level2 == true || wantedLevelScript.level3 == true || wantedLevelScript.level4 == true || wantedLevelScript.level5 == true)
        {
            ChasePlayer();
        }
        if (playerInvisionRadius && playerInshootingRadious && wantedLevelScript.level1 == true || wantedLevelScript.level2 == true || wantedLevelScript.level3 == true || wantedLevelScript.level4 == true || wantedLevelScript.level5 == true)
